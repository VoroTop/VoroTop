...
We provide here a short hands-on tutorial for learning how to use *VoroTop*. Through carefully designed examples, you will learn to perform various types of Voronoi topology analysis, starting from basic calculations to more advanced techniques.
...
Each example has its own directory with a README.md file and data files. To run an example, navigate to the root of this repository in your terminal and follow the instructions provided in the Markdown file for that specific example. Typically, this will involve executing a *VoroTop* command. The output files will be saved in the corresponding directory.

## Tutorial Examples

Here is a brief overview of the ten example problems included in this tutorial:

**[Example 1: Basic Voronoi topology calculations](Example01-Basic/README.md)**
 * Learn how to read a LAMMPS dump file, compute the Voronoi topology of each particle, and interpret the output.

**[Example 2: Voronoi topology analysis through filter files](Example02-FilterAnalysis/README.md)**
 * Learn how to use a filter to classify structure and identify defects in crystalline systems.
...
* *(This example could involve analyzing a series of dump files to track changes in Voronoi topology over time, or a more complex clustering algorithm. You would describe the specific advanced analysis performed here.)*
