...
template<class Container> void count_and_store_neighbors_3d(Container& con);

void calc_distribution_2d (Filter &filter);
template<class Container> void calc_distribution_3d (Container& con, Filter &filter);
...
template<class Container> void print_topology_vectors_3d(Container& con, std::string filename);
...
template<class Container> int classify_particles_by_voronoi_topology_3d(Container& con, Filter &filter);
